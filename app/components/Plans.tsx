...
const Plans = () => {
  return (
    <section
      id="plans"
      className="container m-auto mt-20 p-8 lg:px-20"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8 z-30 relative">
          <div className="flex justify-between flex-col rounded-3xl border-2 border-slate-700 hover:border-main-color-1 duration-700 overflow-hidden z-30 bg-[#07000e]">
            <Image
              ...
              unoptimized
            />
            <div className="flex flex-col p-5 lg:p-12 gap-4">
          ...
          <div className="group flex justify-between flex-col rounded-3xl border-2 border-slate-700 hover:border-main-color-2 duration-700 overflow-hidden  z-30 bg-[#07000e]">
            <div className="flex flex-col gap-4">
              ...
              <h3 className="font-bold text-5xl text-main-color-2 px-5 lg:px-12">
                Influencer
              </h3>
              <ul className="text-slate-300 text-lg px-5 lg:px-12 mb-12">
          ...
          <div className="group flex justify-between flex-col rounded-3xl border-2 border-slate-700  hover:border-main-color-3 duration-700 overflow-hidden  z-30 bg-[#07000e]">
            <Image
            ...
            />
            <div className="flex flex-col gap-4">
              <h3 className="font-bold text-5xl text-main-color-3 px-5 lg:px-12 mt-12">
                Celebrity
              </h3>

              <ul className="text-slate-300 text-lg px-5 lg:px-12">
